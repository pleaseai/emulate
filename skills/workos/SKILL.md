---
name: workos
description: Emulated WorkOS API for local development and testing. Use when the user needs to test WorkOS User Management, organizations, memberships, invitations, API keys, OAuth/OIDC flows, or Vault KV locally with the @workos-inc/node SDK, without hitting api.workos.com.
