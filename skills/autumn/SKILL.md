---
name: autumn
description: Emulated Autumn billing API for local development and testing. Use when the user needs to test autumn-js integrations locally, seed plans and customers, exercise balances track/check, or simulate checkout flows without hitting the real Autumn API.
allowed-tools: Bash(bun:*), Bash(npx @pleaseai/emulate:*), Bash(curl:*)
---

# Autumn Billing API Emulator
