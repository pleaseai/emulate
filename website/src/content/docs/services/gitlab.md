---
title: GitLab
description: "Emulated GitLab GraphQL API for local development and testing."
sidebar:
  label: GitLab
  order: 9
---
...
:::note
Default port **4008** · Package [`@pleaseai/emulate-gitlab`](https://www.npmjs.com/package/@pleaseai/emulate-gitlab)
:::
