---
title: X (Twitter)
description: "Emulated X (Twitter) API v2 for local development and testing."
sidebar:
  label: X (Twitter)
  order: 13
---
...
:::note
Default port **4012** · Package [`@pleaseai/emulate-x`](https://www.npmjs.com/package/@pleaseai/emulate-x)
:::
