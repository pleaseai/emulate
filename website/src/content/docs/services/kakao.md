---
title: Kakao
description: "Emulated Kakao API (kauth OAuth + kapi user/talk) for local development and testing."
sidebar:
  label: Kakao
  order: 1
---
...
:::note
Default port **4000** · Package [`@pleaseai/emulate-kakao`](https://www.npmjs.com/package/@pleaseai/emulate-kakao)
:::
