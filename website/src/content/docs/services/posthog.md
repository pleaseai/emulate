---
title: PostHog
description: "Emulated PostHog analytics API for local development and testing."
sidebar:
  label: PostHog
  order: 10
---
...
:::note
Default port **4009** · Package [`@pleaseai/emulate-posthog`](https://www.npmjs.com/package/@pleaseai/emulate-posthog)
:::
