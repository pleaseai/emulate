...
import { createServer, type Hono, type Store, type AppEnv } from "@emulators/core";
import { kakaoPlugin, seedFromConfig, getKakaoStore } from "../index.js";
...
async function getCode(
  ...
  if (!location) return { code: "", state: null, res };
