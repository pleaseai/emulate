...
function createTestApp() {
  const { app, store } = createServer(linearPlugin, { port: 4012 })
...
async function gql(app: Hono<AppEnv>, query: string, variables?: Record<string, unknown>, token = 'lin_api_seeded') {
