...
import { getKeys, getSupabaseStore, setKeys } from './store.js'

export * from './entities.js'
export { getKeys, getSupabaseStore, setKeys, type SupabaseKeys, type SupabaseStore } from './store.js'
...
function seedUser(
  ...
  if (ss.users.findOneBy('email', email)) {
    return
  }
