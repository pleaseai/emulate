...
const basePort = defaultBasePort()
...
program
  ...
  .option('-p, --port <port>', 'base port (services use port, port+1, ...; falls back to EMULATE_PORT or PORT)', v => Number.parseInt(v, 10), basePort)
